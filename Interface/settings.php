          ...
          foreach (glob($dir) as $file) {
           ...
           ?>
            ...
            <section id="content">
                ...
                ?>
                        <h2>
                            <?php echo $_SESSION['system_settings_title']; ?>
                        </h2>
                        <div class="card">
                            <div class="card-header">
                                <h2>
                                    <?php echo $_SESSION['system_settings_privatetitle']; ?><small><?php echo $_SESSION['system_settings_privatdesc']; ?></small></h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2>
                                    <?php echo $_SESSION['system_settings_pictitle']; ?><small><?php echo $_SESSION['system_settings_picdesc']; ?></small></h2>
                            </div>
                            <div class="card-body card-padding">
